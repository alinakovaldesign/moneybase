...
*Evidence: App Store screenshots archived in `01-research/outputs/refs/`; web-app observations from live.moneybase.com pre-login session (2026-07-12); Mobbin links inline.*
